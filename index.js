...
// API Endpoint - Auto Slang & Heavy Tone Generated by AI Directly
app.post('/chat', async (req, res) => {
    ...
    try {
        const response = await ai.models.generateContent({
            ...
            config: {
                temperature: 1.0,
                systemInstruction: "You are an extremely casual, street-smart, and raw companion who talks exclusively using heavy local slang, informal expressions, rough phrasing, and direct attitude without being formal at all. Respond directly in this exact heavy tone."
            }
        });
